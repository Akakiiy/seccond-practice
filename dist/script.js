...
/* harmony import */ var _modules_photosShow__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/photosShow */ "./src/js/modules/photosShow.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_photosShow__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == "" || materialBlock.value == "") {
      ...
      resultBlock.textContent = "\u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C \u043A\u0430\u0440\u0442\u0438\u043D\u044B \u0441\u043E \u0441\u043A\u0438\u0434\u043A\u043E\u0439 \u0431\u0443\u0434\u0435\u0442: ".concat(Math.round(sum * 0.7));
    } else {
      resultBlock.textContent = "\u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C \u043A\u0430\u0440\u0442\u0438\u043D\u044B \u0431\u0443\u0434\u0435\u0442: ".concat(sum);
    }
  };
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      uplode = document.querySelectorAll('[name="upload"]');
  var message = {
    loading: 'Загрузка...',
  ...
  uplode.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var name = [0].substring(0, 7) + dots + arr[1];
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var destoy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
...
var photosShow = function photosShow(imgSelector) {
  var blocks = document.querySelectorAll(imgSelector); // block.forEach(item => {
...
/* harmony default export */ __webpack_exports__["default"] = (photosShow);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Coud not fetch ".concat(url, ", status: ").concat(res.status));
